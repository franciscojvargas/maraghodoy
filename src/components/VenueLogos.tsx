...
function VenueItem({
  ...
  if (useText) {
    return (
      <span className={`flex items-center justify-center h-12 md:h-20 ${textLogoClass}`}>
        {textLabel}
      </span>
    );
  }
  ...
  return (
    <span className="relative flex h-16 w-24 md:h-32 md:w-80">
      <Image
        src={logo}
        alt={name}
        fill
...
export default function VenueLogos() {
  ...
  return (
    <div className="mt-8 md:mt-10 grid grid-cols-3 place-items-center gap-4 md:gap-10 max-w-4xl mx-auto">
