        ...
        <AppleReveal delay={0.06}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-4 p-5 rounded-2xl border border-white/20 bg-white/5 hover:bg-white/10 hover:border-white/30 transition-all duration-200 w-full sm:col-span-2"
